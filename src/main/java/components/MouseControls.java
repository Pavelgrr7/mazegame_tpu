...
public class MouseControls extends Component {
    ...
    public void pickupObject(GameObject go) {
        ...
        this.holdingObject.getComponent(SpriteRenderer.class)
    ...
    public void place() {
        ...
        if (newObj.getComponent(StateMachine.class) != null) {
            newObj.getComponent(StateMachine.class)
                    .refreshTextures();
        }
        newObj.getComponent(SpriteRenderer.class)
    ...
    public void editorUpdate(float dt) {
        ...
        if (holdingObject != null && debounce <= 0) {
            ...
            holdingObject.transform.position.x = ((int)Math.floor(holdingObject.transform.position.x / Settings.GRID_WIDTH) * Settings.GRID_WIDTH);
            holdingObject.transform.position.y = ((int)Math.floor(holdingObject.transform.position.y / Settings.GRID_HEIGHT) * Settings.GRID_HEIGHT);
        ...
        } else if (!MouseListener.isDragging() && MouseListener.mouseButtonDown(GLFW_MOUSE_BUTTON_LEFT) && debounce < 0 && GameViewWindow.getWantCaptureMouse()) {
